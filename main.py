...
from forms import CreatePostForm, RegisterForm, \
    LoginForm, CommentForm  # importing CreatePostForm, RegisterForm and LoginForm from forms.py
from functools import wraps
from flask import abort

import os  # for postgres in heroku
...
Base = declarative_base()  # one to many relationship between tables
...
year = date.today().year  # getting current year


# ###############        CONFIGURE TABLES       #################  #
class User(UserMixin, db.Model):  # Create the User Table which will contain all the users
    __tablename__ = "users"
...
class BlogPost(db.Model):  # blog_post table which will contain all the blog posts
...
def register():
    ...
    return render_template("register.html", current_user=current_user, form=form, year=year)
